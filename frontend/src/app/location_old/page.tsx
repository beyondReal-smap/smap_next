              ...
              <div className="flex items-center space-x-1">
                {isEditingPanel && (
                  <button
                    ...
                    className={`p-1.5 rounded-md hover:bg-gray-100 transition-colors ${newLocation.notifications ? 'text-yellow-500 hover:text-yellow-600' : 'text-red-500 hover:text-red-600'
                      }`}
            ...
            <div className="px-4 pb-4">
              ...
              <div className="flex justify-center items-center my-2">
                <button
                  ...
                  className={`w-2.5 h-2.5 rounded-full mx-1.5 focus:outline-none ${activeView === 'selectedMemberPlaces' ? 'bg-indigo-600 scale-110' : 'bg-gray-300'
                    } transition-all duration-300`}
                  aria-label="선택된 멤버 장소 뷰로 전환"
                />
                <button
                  onClick={() => handleViewChange('otherMembersPlaces')}
                  className={`w-2.5 h-2.5 rounded-full mx-1.5 focus:outline-none ${activeView === 'otherMembersPlaces' ? 'bg-indigo-600 scale-110' : 'bg-gray-300'
                    } transition-all duration-300`}
