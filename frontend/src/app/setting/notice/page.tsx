          ...
          <div className="flex items-center justify-between h-14 px-4" style={{ 
            ...
            >
              ...
              <div className="flex flex-col justify-center" style={{ margin: '0', padding: '0' }}>
                <h1 className="text-lg font-bold text-gray-900 leading-tight" style={{ margin: '0', padding: '0', lineHeight: '1.2' }}>공지사항</h1>
                <p className="text-xs text-gray-500 leading-tight" style={{ margin: '0', padding: '0', lineHeight: '1.2' }}>최신 소식 및 업데이트</p>
              </div>
            </motion.div>
