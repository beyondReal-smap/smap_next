  ...
  return (
    <div className="bg-white min-h-screen px-4 pt-8 pb-24">
      ...
      <div className="flex items-center mb-2">
        ...
        <span className="text-lg font-semibold text-gray-900">SMAP의 모든 기능을 제한없이<br /> 경험해 보세요.</span>
      </div>
      ...
      <div className="space-y-3">
        ...
        <div className={`flex items-center justify-between rounded-2xl border ${selected === 'month' ? 'border-blue-500 bg-blue-50' : 'border-gray-200 bg-white'} px-5 py-5 transition-all`}
          ...
          <div>
            <div className="text-base font-medium mb-1 text-gray-900">월간</div>
            <div className="text-xl font-bold text-gray-900">₩4,900 <span className="text-base font-normal">/ 월</span></div>
          </div>
        ...
        <div className={`relative flex items-center justify-between rounded-2xl border ${selected === 'year' ? 'border-blue-600 bg-blue-50' : 'border-gray-200 bg-white'} px-5 py-5 transition-all`}
          ...
          <div className="absolute -top-3 -left-3">
            <span className="bg-yellow-400 text-xs font-bold px-3 py-1 rounded-full shadow text-gray-900">인기!!</span>
          </div>
          <div>
            <div className="text-base font-medium mb-1 text-gray-900">연간</div>
