...
.full-map-container {
  position: fixed !important;
  top: 20px !important; /* 헤더 높이만큼 아래에서 시작 */
  left: 0 !important;
  right: 0 !important;
  bottom: 80px !important; /* 네비게이션 바 높이만큼 제외 */
  width: 100vw !important;
  height: calc(100vh - 100px) !important; /* 헤더(20px) + 네비게이션(80px) 제외 */
  margin: 0 !important;
  padding: 0 !important;
...
.full-map-container > div > div {
  ...
  /* 지도 로딩 중 크기 고정 */
  min-height: calc(100vh - 100px) !important; /* 헤더(20px) + 네비게이션(80px) 제외 */
  ...
  padding: 0 !important;
  /* 네이버 지도 캔버스 크기 강제 설정 */
  max-height: calc(100vh - 100px) !important; /* 헤더(20px) + 네비게이션(80px) 제외 */
        ...
        try {
          ...
          setTimeout(() => {
            if (naverMap.current && naverMapContainer.current) {
              ...
              const mapHeight = window.innerHeight - 100; // 헤더(20px) + 네비게이션 바(80px) 제외
      ...
      <>
        ...
        <div
          ...
          style={{
            ...
            // CLS 방지를 위한 추가 속성
            width: '100vw',
            height: 'calc(100vh - 100px)', // 헤더(20px) + 네비게이션(80px) 제외
        ...
        >
          ...
          <div 
            ...
            style={{ 
              ...
              width: '100%',
              height: '100%',
              minHeight: 'calc(100vh - 100px)', // 헤더(20px) + 네비게이션(80px) 제외
              minWidth: '100vw',
              maxHeight: 'calc(100vh - 100px)', // 헤더(20px) + 네비게이션(80px) 제외
              maxWidth: '100vw',
              contain: 'layout style paint',
              willChange: 'auto',
              // 정확한 크기 보장
