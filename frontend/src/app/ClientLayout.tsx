...
function IOSCompatibleSpinner({ message = '로딩 중...' }: { message?: string }) {
    ...
    <div className="flex items-center justify-center min-h-screen">
      <div className="text-center bg-white rounded-2xl p-6 shadow-lg">
        <div className="flex items-center justify-center mb-4">
          <div 
            ref={spinnerRef}
            className="w-12 h-12 border-4 border-gray-200 border-t-blue-600 rounded-full unified-animate-spin"
            style={{
...
function AuthGuard({ children }: { children: React.ReactNode }) {
  ...
  // 로딩 중이면 로딩 화면 표시
  if (loading) {
    return <IOSCompatibleSpinner message="로딩 중..." />;
  }
