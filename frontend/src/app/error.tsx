      ...
      <div className="text-center max-w-md mx-auto">
        <div className="bg-white rounded-2xl shadow-lg p-8 border border-yellow-100">
          ...
          <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4 mb-6 text-left">
            <p className="text-sm text-yellow-800 font-medium mb-2">에러 상세:</p>
          ...
          <div className="space-y-4">
            ...
            <button
              onClick={reset}
              className="block w-full bg-gradient-to-r from-yellow-500 to-orange-600 text-white font-semibold py-3 px-6 rounded-xl hover:from-yellow-600 hover:to-orange-700 transition-all duration-200 transform hover:scale-105 shadow-lg"
            >
              다시 시도
            </button>
          ...
          <div className="mt-8 pt-6 border-t border-gray-100">
            <p className="text-sm text-gray-500">
              문제가 지속되면{' '}
              <Link href="/setting" className="text-yellow-600 hover:text-yellow-700 underline">
                설정
              </Link>
              에서 도움을 받을 수 있습니다.
            </p>
