            ...
            >
              ...
              >
                ...
                <div className="px-6 py-6 space-y-6">
                  <div>
                    <h4 className="text-lg font-semibold text-gray-900 mb-2" style={{ wordBreak: 'keep-all' }}>
              ...
              >
                ...
                <div className="flex-1 overflow-y-auto">
                  ...
                  >
                    ...
                    <div className="flex items-center space-x-2 mb-4">
                      ...
                      <div className="mb-4">
                        ...
                        <div className="relative group-selector-container">
                          ...
                          >
                            <span className="text-gray-900" style={{ wordBreak: 'keep-all' }}>
                              {selectedGroupId 
                    ...
                    {/* 제목 입력 */}
                      <div className="mb-4">
                      <label className="block text-sm font-medium text-gray-700 mb-2" style={{ wordBreak: 'keep-all' }}>
                      ...
                      {/* 내용 입력 */}
                    <div>
                        <label className="block text-sm font-medium text-gray-700 mb-2" style={{ wordBreak: 'keep-all' }}>일정 내용 (선택)</label>
                      <textarea
                      ...
                      />
                        <div className="flex justify-between mt-2">
                        <p className="text-xs text-gray-500" style={{ wordBreak: 'keep-all' }}>예) 회의 안건, 준비물, 참고사항 등</p>
                    ...
                    <div className="flex items-center space-x-2 mb-4">
                      ...
                      {/* 설정 안내 텍스트 */}
                      <p className="text-xs text-gray-500 text-center" style={{ wordBreak: 'keep-all' }}>위 카드를 클릭하여 날짜와 시간을 설정하세요</p>
                        </div>
