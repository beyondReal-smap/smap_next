                                      ...
                                      <div className="space-y-1 pl-4">
                                        ...
                                        {(event.distanceText || event.memberGpsTime) && (
                                          <div className="space-y-1 mt-2">
                                            {/* 거리 정보 */}
                                            {event.distanceText && (
                                              <div className="flex items-center space-x-1.5 bg-green-50 px-2 py-1.5 rounded-md border border-green-200 shadow-sm">
                                                <svg className="w-3.5 h-3.5 text-green-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" />
                                                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" />
                                                </svg>
                                                <span className="text-xs font-medium text-green-700">목적지까지</span>
