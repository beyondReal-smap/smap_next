...
import { useFCMTokenRegistrationSuccess, useFCMTokenRegistrationFailed } from '../../../hooks/useIOSBridge';
...
export default function AppLayout({ children }: AppLayoutProps) {
  ...
  // FCM 토큰 등록 성공 처리
  useFCMTokenRegistrationSuccess((data) => {
    console.log('✅ [FCM] 토큰 등록 성공 이벤트 처리:', data);
    setFcmNotification({
      type: 'success',
      message: '푸시 알림이 성공적으로 설정되었습니다.'
    });
            ...
            <div className={`p-4 rounded-lg shadow-lg border ${
              ...
              <div className="flex items-center">
                ...
                <div className="ml-auto pl-3">
                  <button
                    onClick={() => setFcmNotification({ type: null, message: '' })}
