            ...
            VStack(alignment: .leading, spacing: 24) {
                ...
                VStack(alignment: .leading, spacing: 20) {
                    ...
                    VStack(alignment: .leading, spacing: 0) {
                        ...
                        HStack(spacing: 0) {
                            Text("구분")
                                .font(.suite(size: 13, weight: .bold))
                        ...
                        HStack(alignment: .top, spacing: 0) {
                            Text("위치 정보\n(필수)")
                                ...
                                .frame(width: 80, alignment: .leading)
                                .padding(8)
                            Text("실시간 GPS 위치 데이터, 이동 경로, 기기 위치 정보")
                                .font(.suite(size: 12))
                                .frame(maxWidth: .infinity, alignment: .leading)
                                .padding(8)
                            Text("그룹 내 실시간 위치 공유, 일정 장소 기반 알림, 위치 기반 서비스 제공")
                                .font(.suite(size: 12))
                                .frame(maxWidth: .infinity, alignment: .leading)
                                .padding(8)
                        }
                        ...
                        HStack(alignment: .top, spacing: 0) {
                            Text("회원 정보\n(필수)")
                                ...
                                .frame(width: 80, alignment: .leading)
                                .padding(8)
                            Text("이메일 주소, 비밀번호, 닉네임, 프로필 사진")
                                .font(.suite(size: 12))
                                .frame(maxWidth: .infinity, alignment: .leading)
                                .padding(8)
                            Text("서비스 가입 및 본인 확인, 사용자 식별")
                                .font(.suite(size: 12))
                                .frame(maxWidth: .infinity, alignment: .leading)
                                .padding(8)
                        }
                        ...
                        HStack(alignment: .top, spacing: 0) {
                            Text("기기 정보\n(필수)")
                                ...
                                .frame(width: 80, alignment: .leading)
                                .padding(8)
                            Text("단말기 식별번호(ID), OS 버전, 방문 기록")
                                .font(.suite(size: 12))
                                .frame(maxWidth: .infinity, alignment: .leading)
                                .padding(8)
                            Text("서비스 최적화 및 부정 이용 방지")
                                .font(.suite(size: 12))
                                .frame(maxWidth: .infinity, alignment: .leading)
                                .padding(8)
                        }
                    ...
                    TermSection(title: "2. 위치정보의 보호 및 이용 (추가)", content: """
...
""")
                    ...
                    TermSection(title: "3. 개인정보의 제3자에 대한 제공", content: """
...
""")
                    ...
                    VStack(alignment: .leading, spacing: 8) {
                        ...
                        VStack(alignment: .leading, spacing: 4) {
                            Text("성명: 정진")
                                .font(.suite(size: 14))
                            Text("전화: 070-8065-2207")
                                .font(.suite(size: 14))
                            Text("이메일: admin@smap.site")
                                .font(.suite(size: 14))
                        }
                        .foregroundColor(.gray)
                    }
