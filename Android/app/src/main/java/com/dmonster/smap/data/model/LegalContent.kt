...
/**
 * 약관 및 정책 텍스트 데이터 (iOS RootCoordinatorView.swift에서 추출)
 */
object LegalContent {
    ...
    val ServiceTerms = LegalDocument(
        ...
        sections = listOf(
            ...
            """.trimIndent()),
            TermSection("제3조(약관 외 준칙)", "이 약관에서 정하지 아니한 사항은 법령 또는 회사가 정한 서비스의 개별약관, 운영정책 및 규칙 등(이하 \"세부지침\")의 규정에 따르며, 본 약관과 세부지침이 충돌할 경우 세부지침이 우선합니다."),
            TermSection("제4조(약관의 효력과 변경)", """
    ...
    val PrivacyPolicy = LegalDocument(
        ...
        """.trimIndent(),
        sections = listOf(
            TermSection("개인정보 수집 항목 및 이용목적", "\"회사\"는 회원가입, 원활한 고객상담, 각종 서비스의 제공을 위해 아래와 같은 최소한의 개인정보를 필수항목으로 수집하고 있습니다."),
            TermSection("개인정보의 제3자에 대한 제공", "회사는 원칙적으로 이용자의 개인정보를 제1조(개인정보의 처리목적)에서 명시한 범위 내에서 처리하며, 이용자의 사전 동의 없이는 본래의 범위를 초과하여 처리하거나 제3자에게 제공하지 않습니다."),
            TermSection("개인정보의 처리 및 보유기간", "회사는 법령에 따른 개인정보 보유·이용기간 또는 정보주체로부터 개인정보를 수집 시에 동의받은 개인정보 보유·이용기간 내에서 개인정보를 처리·보유합니다."),
            TermSection("개인정보의 파기", "회사는 개인정보 보유기간의 경과, 처리목적 달성 등 개인정보가 불필요하게 되었을 때에는 지체없이 해당 개인정보를 파기합니다."),
            TermSection("정보주체의 권리·의무 및 행사방법", "이용자는 개인정보주체로서 다음과 같은 권리를 행사할 수 있습니다."),
            TermSection("개인정보 보호책임자", """
                회사는 개인정보 처리에 관한 업무를 총괄해서 책임지고, 개인정보 처리와 관련한 정보주체의 불만처리 및 피해구제 등을 위하여 아래와 같이 개인정보 보호책임자를 지정하고 있습니다.
                
                담당: 정진 | 전화: 070-8065-2207 | 이메일: admin@smap.site
            """.trimIndent())
        )
    )
    ...
    val LocationTerms = LegalDocument(
        ...
        sections = listOf(
            ...
            """.trimIndent()),
            TermSection("제4조(서비스 해지)", "회원은 회사가 정한 절차를 통해 서비스 해지를 신청할 수 있습니다."),
            TermSection("제5조(이용약관의 효력 및 변경)", """
            ...
            """.trimIndent()),
            TermSection("제6조(약관 외 준칙)", "본 약관에 명시되지 않은 사항은 관계 법령 및 건전한 거래관행에 따릅니다."),
            TermSection("제7조(서비스의 내용)", """
    ...
    val ThirdPartyProvision = LegalDocument(
        ...
        sections = listOf(
            ...
            TermSection("제공 목적", "위치기반 서비스 공유 지원, 맞춤형 콘텐츠 정보 제공"),
            TermSection("제공하는 항목", "이름, 닉네임, 위치정보, 프로필 사진"),
            TermSection("보유 및 이용기간", "서비스 이용 기간 내 또는 동의 철회 시까지")
        )
    )
    ...
    val MarketingConsent = LegalDocument(
        ...
        sections = listOf(
            ...
            TermSection("마케팅 정보 이용 목적", """
                ...
                • 마케팅 성과 분석 및 통계
            """.trimIndent()),
            TermSection("동의 철회 및 거부", "고객은 언제든지 마케팅 정보 수집 및 이용에 대한 동의를 철회하거나 거부할 수 있습니다.")
        )
    )
}
