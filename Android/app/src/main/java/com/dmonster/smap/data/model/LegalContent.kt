...
object LegalContent {
    ...
    val PrivacyPolicy = LegalDocument(
        ...
        """.trimIndent(),
        sections = listOf(
            TermSection("1. 개인정보 수집 항목 및 이용목적", """
            ...
            """.trimIndent()),
            TermSection("2. 위치정보의 보호 및 이용 (추가)", """
            ...
            """.trimIndent()),
            TermSection("3. 개인정보의 제3자에 대한 제공", """
                회사는 이용자의 사전 동의 없이 개인정보를 외부에 제공하지 않습니다.
                
                단, 그룹 공유 기능을 선택하여 이용자가 스스로 위치 정보를 그룹 멤버에게 노출하는 경우는 예외로 합니다.
            """.trimIndent()),
            TermSection("4. 개인정보의 파기", "개인정보는 수집 및 이용목적이 달성되면 지체 없이 파기합니다. 전자적 파일 형태는 복구가 불가능한 기술적 방법을 사용하여 삭제합니다."),
            TermSection("5. 개인정보 보호책임자", """
